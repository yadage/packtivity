...
def test_cliload_valid():
    load_pack('tests/testspecs/noop-test.yml', os.getcwd(), schemadir, True)

def test_cliload_non_valid():
    with pytest.raises(ValidationError):
        load_pack('tests/testspecs/noop-test-invalid.yml', os.getcwd(), schemadir, True)

def test_cliload_accept_non_valid():
    load_pack('tests/testspecs/noop-test-invalid.yml', os.getcwd(), schemadir, False)
